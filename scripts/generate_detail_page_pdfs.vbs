...
Dim sourceDoc
Set sourceDoc = FindDocumentByName("MiniDrone.CATProduct", "ProductDocument")
If sourceDoc Is Nothing Then
  WScript.Echo "ERROR: MiniDrone.CATProduct is not open in CATIA."
  WScript.Quit 1
End If

CreateDetailPages sourceDoc.Product, "MiniDrone_detail_pages", 0.8

Dim explodedName
explodedName = "MiniDrone_exploded_detail_pages"
...
WScript.Echo "OK: " & fso.BuildPath(outputDir, "MiniDrone_detail_pages.CATDrawing")
WScript.Echo "OK: " & fso.BuildPath(outputDir, "MiniDrone_detail_pages.pdf")
