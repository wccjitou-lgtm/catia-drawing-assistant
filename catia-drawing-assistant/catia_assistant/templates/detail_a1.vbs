...
CreateA1MultiView sourceDoc.Product, "$BASE_NAME$_multiview_detail_A1", 0.42

Dim explodedName
explodedName = "$BASE_NAME$_exploded_multiview_detail_A1"
...
CreateA1MultiView explodedDoc.Product, explodedName, 0.22

WScript.Echo "OK: " & fso.BuildPath(outputDir, "$BASE_NAME$_multiview_detail_A1.CATDrawing")
WScript.Echo "OK: " & fso.BuildPath(outputDir, "$BASE_NAME$_multiview_detail_A1.pdf")
...
Sub CreateA1MultiView(ByVal product, ByVal outputBaseName, ByVal viewScale)
  ...
  sheet.PaperSize = CAT_PAPER_A1
  sheet.Orientation = CAT_PAPER_LANDSCAPE
  sheet.ProjectionMethod = CAT_FIRST_ANGLE
  sheet.Scale = viewScale
  Set views = sheet.Views

  AddOrthographicView views, product, "Front view", 330, 300, viewScale, 1, 0, 0, 0, 0, 1
  AddOrthographicView views, product, "Left view", 150, 300, viewScale, 0, -1, 0, 0, 0, 1
  AddOrthographicView views, product, "Right view", 510, 300, viewScale, 0, 1, 0, 0, 0, 1
  AddOrthographicView views, product, "Top view", 330, 480, viewScale, 1, 0, 0, 0, 1, 0
  AddOrthographicView views, product, "Bottom view", 330, 120, viewScale, 1, 0, 0, 0, -1, 0
  AddOrthographicView views, product, "Rear view", 690, 300, viewScale, -1, 0, 0, 0, 0, 1
  AddIsometricView views, product, "Isometric view", 680, 480, viewScale
